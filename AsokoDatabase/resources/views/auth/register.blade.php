...
@section('content-holder')<div class="container">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="exampleRepeatPassword-confirm" type="password"
                                    ...
                                    <a class="text-center" href="{{ route('home.index') }}">Back to Asoko Database
                                        Sytem</a>
                                </form>
                            </div>
                        </div>
